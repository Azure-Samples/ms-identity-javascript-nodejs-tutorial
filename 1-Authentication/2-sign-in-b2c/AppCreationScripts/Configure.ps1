...
#> 
   ...
   Write-Host "Creating the AAD application (WebAppB2C)"
   ...
   $webAppAadApplication = New-AzureADApplication -DisplayName "WebAppB2C" `
                                                  -HomePage "https://localhost:4000" `
                                                  -ReplyUrls "https://localhost:4000/redirect" `
                                                  -IdentifierUris "https://$tenantName/WebAppB2C" `
   ...
   Write-Host "Done creating the webApp application (WebAppB2C)"
   ...
   Add-Content -Value "<tr><td>webApp</td><td>$currentAppId</td><td><a href='$webAppPortalUrl'>WebAppB2C</a></td></tr>" -Path createdApps.html
