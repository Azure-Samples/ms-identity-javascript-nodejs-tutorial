...
export declare class AuthProvider {
     ...
     * @param {NextFunction} next: express next function
     */
    handleRedirect: (req: Request | any, res: Response, next: NextFunction) => Promise<void>;
    /**
     ...
     */
    getToken: (req: Request | any, res: Response, next: NextFunction) => Promise<void>;
    /**
     ...
     * @param {Function} next: express next
     */
    isAuthorized: (req: Request, res: Response, next: NextFunction) => Promise<any>;
    /**
