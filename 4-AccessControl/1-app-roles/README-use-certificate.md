...
```bash
openssl req -x509 -newkey rsa:2048 -keyout msal-node-webapp.key -out msal-node-webapp.cer -subj "/CN=msal-node-webapp" -nodes

Generating a RSA private key
.........................................................
writing new private key to 'msal-node-webapp.key'
```

The following files should be generated: *msal-node-webapp.key*, *msal-node-webapp.cer*

If you need, you can generate a msal-node-webapp.pfx (certificate + private key combination) with the command below:

```bash
openssl pkcs12 -export -out CertificateName.pfx -inkey msal-node-webapp.key -in msal-node-webapp.cer
```

Enter an export password when prompted and make a note of it. The following file should be generated: *msal-node-webapp.pfx*.
...
1. Open the file where MSAL is initialized (e.g. `4-AccessControl\1-app-roles\App\app.js`).
