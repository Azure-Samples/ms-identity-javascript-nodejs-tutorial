...
#> 
    ...
    # Add the roles
    Write-Host "Adding app roles to to the app 'msal-node-webapp' in tenant '$tenantName'"

    $app=Get-AzureADApplication -Filter "DisplayName eq 'msal-node-webapp'" 
    ...
    if ($app)
    {
        ...
        Write-Host -ForegroundColor Red "Failed to add app roles to the app 'msal-node-webapp'."
    }
